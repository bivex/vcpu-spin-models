...
#define PanSource	"vcpu_rolling_state.pml"
...
#define _nstates1	11	/* :init: */
#define minseq1	28
#define maxseq1	37
#define _endstate1	10

#define _nstates0	29	/* RollingVCPU */
#define minseq0	0
#define maxseq0	27
...
struct BytecodeInst { /* user defined type */
	uchar enc_opcode;
	uchar enc_operand;
};
...
#define PRollingVCPU	((P0 *)_this)
typedef struct P0 { /* RollingVCPU */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _2_1_raw_op) - 1*sizeof(uchar))
